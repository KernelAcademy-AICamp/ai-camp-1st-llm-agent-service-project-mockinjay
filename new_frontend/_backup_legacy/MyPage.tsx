 ...
 * - Profile card with gradient background displaying user stats (points, level, tokens, subscription)
 * - 3-tab system for managing account, personal, and disease information
 * - Editable forms with validation
 * - Action cards for hospital test results and subscription management
 * - Logout and account withdrawal functionality
 *
 * Design System:
 * - Gradient backgrounds for visual hierarchy
 * - Consistent teal (#00C9B7) and purple (#9F7AEA) accent colors
...
export function MyPage() {
  ...
  /**
   * Logout handler
   * Clears authentication state and redirects to chat page
   */
  const handleLogout = () => {
    logout();
    navigate('/chat');
  ...
  /**
   * Account withdrawal handler
   * Removes user account and clears authentication state
   */
  ...
  /**
   * Save handler for account information
  ...
  /**
   * Save handler for personal information
   * Updates personal details on the server
   */
  ...
  /**
   * Save handler for disease information
   * Updates disease stage on the server
   */
  const handleSaveDisease = () => {
    // TODO: Implement API call to update disease info
    console.log('Saving disease info:', diseaseStage);
  };

  /**
   * Tab Button Component
   * Renders a tab with active state indicator
   */
  const TabButton = ({
    id,
    label
  }: {
    id: 'account' | 'personal' | 'disease';
    label: string;
  }) => (
    <button
    ...
    >
      {label}
      {activeTab === id && (
        <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#9F7AEA]" aria-hidden="true" />
      )}
    </button>
  );

  // Disease stage options for CKD patients
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-6 lg:p-10 max-w-4xl mx-auto w-full">
          ...
          <div className="bg-gradient-to-r from-[#F2FFFD] to-[#F8F4FE] rounded-xl p-6 mb-8 border border-[#E5E7EB]">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00C9B7] to-[#9F7AEA] flex items-center justify-center flex-shrink-0">
                <User size={24} color="white" strokeWidth={2} aria-hidden="true" />
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="flex items-center gap-1.5">
                <Star size={14} className="text-[#FFB84D]" strokeWidth={2} aria-hidden="true" />
              ...
              {/* Tokens */}
              <div className="flex items-center gap-1.5">
                <Coins size={14} className="text-[#00C9B7]" strokeWidth={2} aria-hidden="true" />
              ...
              {/* Subscription */}
              <div className="flex items-center gap-1.5">
                <CreditCard size={14} className="text-[#9CA3AF]" strokeWidth={2} aria-hidden="true" />
          ...
          {/* Tab Navigation */}
          <div className="flex border-b border-[#E5E7EB] mb-8" role="tablist">
          ...
          <div className="bg-white mb-10">
            ...
            {activeTab === 'account' && (
              <div className="border border-[#E5E7EB] rounded-xl p-6 space-y-6" role="tabpanel">
                <div>
                  <label htmlFor="email" className="block text-sm font-bold text-[#374151] mb-2">
                    이메일
                  </label>
                  <input
                    id="email"
                ...
                <div>
                  <label htmlFor="password" className="block text-sm font-bold text-[#374151] mb-2">
                    비밀번호
                  </label>
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl text-white font-bold text-lg shadow-lg transition-colors flex items-center justify-center gap-2 hover:opacity-90"
            ...
            {activeTab === 'personal' && (
              <div className="border border-[#E5E7EB] rounded-xl p-6" role="tabpanel">
                <div className="space-y-6 mb-8">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3" role="group" aria-label="사용자 유형 선택">
                      {['일반인', '신장병 환우', '연구자'].map((type) => (
                        <button
                          ...
                          aria-pressed={accountInfo.userType === type}
                          aria-label={type}
                        >
                          {type}
                        </button>
                  ...
                  {/* Nickname */}
                  <div>
                    <label htmlFor="nickname" className="block text-sm font-bold text-[#374151] mb-2">
                      닉네임
                    </label>
                    <input
                      id="nickname"
                  ...
                  <div>
                    ...
                    <div className="flex gap-3" role="group" aria-label="성별 선택">
                      {['남성', '여성', '기타'].map((gender) => (
                        <button
                          key={gender}
                          ...
                          aria-pressed={personalInfo.gender === gender}
                          aria-label={gender}
                        >
                          {gender}
                        </button>
                  ...
                  {/* Birth Date */}
                  <div>
                    <label htmlFor="birthDate" className="block text-sm font-bold text-[#374151] mb-2">
                      생년월일
                    </label>
                    <div className="relative">
                      ...
                      <Calendar
                        size={20}
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 text-[#9CA3AF] pointer-events-none"
                        aria-hidden="true"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label htmlFor="height" className="block text-sm font-bold text-[#374151] mb-2">
                        키 (cm)
                      </label>
                      <input
                        id="height"
                    ...
                    <div>
                      <label htmlFor="weight" className="block text-sm font-bold text-[#374151] mb-2">
                        체중 (kg)
                      </label>
                      <input
                        id="weight"
            ...
            {activeTab === 'disease' && (
              <div className="border border-[#E5E7EB] rounded-xl p-6" role="tabpanel">
                <div className="space-y-6 mb-8">
                  <div>
                    <label htmlFor="diseaseStage" className="block text-sm font-bold text-[#374151] mb-2">
                      병원 진단 명
                    </label>
                    <select
                      id="diseaseStage"
          ...
          <div className="border-t border-[#F3F4F6] pt-6 mb-8">
            ...
            <button
              ...
              aria-label="병원검사결과 자세히 보기"
            >
              <div className="flex items-center gap-3">
                <FileText size={24} className="text-[#00C9B7]" aria-hidden="true" />
            ...
            <button
              ...
              aria-label="구독결제 자세히 보기"
            >
              <div className="flex items-center gap-3">
                <CreditCard size={24} className="text-[#00C9B7]" aria-hidden="true" />
