...
export default function QuizListPage() {
  ...
  const progressPercent = Math.round((completedCount / quizList.length) * 100);
          ...
          <div className="grid gap-4">
            {quizList.map((quiz) => (
              <button
                ...
                className="w-full text-left p-5 rounded-xl border border-[#E0E0E0] bg-white hover:bg-gray-50 hover:border-[#00C9B7] transition-all duration-200 relative group"
              >
