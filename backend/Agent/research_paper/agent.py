...
class ResearchPaperAgent(LocalAgent):
    """
    Research Paper Agent - Parlant Remote Agent
    """
    ...
    async def process(self, request: AgentRequest) -> AgentResponse:
        """
        Process research paper search request
        ...
        try:
            ...
            idle_timeout = 120  # Exit if no messages for 180 seconds (increased for search_medical_qa)
